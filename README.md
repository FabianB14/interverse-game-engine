...
docs/
  ...
  play/            Published browser build of the engine reference runtime.
...
When GitHub Pages is configured to publish the `/docs` folder, the installed Studio includes the same runtime at `/play/`.
